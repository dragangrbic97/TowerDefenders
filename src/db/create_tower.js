...
exports.createTower = void 0;
var Tower = require("./models/tower");
var Constants_1 = require("../utils/Constants");
function createTower() {
    return __awaiter(this, void 0, void 0, function () {
        var towerData, towerEntry, dataValues, id, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, Tower.create(towerData, { logging: console.log })];
                case 2:
                    towerEntry = _a.sent();
                    console.log("Tower has been created");
                    dataValues = towerEntry.dataValues;
                    id = dataValues.id;
                    return [2 /*return*/, id];
                case 3:
                    error_1 = _a.sent();
