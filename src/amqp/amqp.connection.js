            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, amqplib_1.connect)({
                                hostname: 'localhost',
                                port: 5672,
                                username: 'myuser',
                                password: 'mypassword'
...
function makeChannel(connection) {
    var channel;
...
function initRabbitMq() {
    return __awaiter(this, void 0, void 0, function () {
        var connect, connection, createChannel;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    connection = _a.sent();
                    createChannel = makeChannel(connection);
                    return [2 /*return*/, createChannel()];
            }
        });
    });
}
